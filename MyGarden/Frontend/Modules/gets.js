...
export const getCurrentlyActiveRelays = async (setState) => {
  try {
    const response = await axios(`http://192.168.1.179:3000/currentlyActive`);
...
export const getMostCommonActivationReason = async (setMostCommon) => {
  try {
    const response = await axios(
      `http://192.168.1.179:3000/activationHistory/getMostCommonActivationReason`
    );
...
export const getActivations = async (setActivations) => {
  try {
    const response = await fetch(
      `http://192.168.1.179:3000/activationHistory`
    );
...
export const getScheduleActivation = async (
  ...
  try {
    const response = await axios(
      `http://192.168.1.179:3000/scheduleActivation`
    );
...
export const getSysMod = async (setIsActive, setMaxTemp, setMinMoist) => {
  try {
    const response = await axios(`http://192.168.1.179:3000/SysMod`);
...
export const getSamples = async (setSamples) => {
  try {
    const response = await axios(`http://192.168.1.179:3000/samples`);
